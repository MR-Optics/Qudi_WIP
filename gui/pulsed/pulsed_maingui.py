...
class PulsedMeasurementGui(GUIBase):
    ...
    def _connect_analysis_tab_signals(self):
        ...
        self._pa.textEdit.textChanged.connect(self.set_save_comments)
        return
    ...
    ###########################################################################
    def set_save_comments(self):
        comments = self._pa.textEdit.toPlainText()
        self.pulsedmasterlogic().set_comments(comments)
        return

...
class ODMRCounterMicrowaveInterfuse(GenericLogic, ODMRCounterInterface,
    ...
    def on_activate(self):
        ...
        self.pulse_device = self.pulse_streamer()
        pass
    ...
    def set_up_odmr(self, counter_channel=None, photon_source=None,
        ...
        @return int: error code (0:OK, -1:error)
        """
        self.pulse_device.turn_on_laser()
        self.pulse_device.turn_on_mw()
    ...
    def set_cw(self, frequency=None, power=None):
        ...
        @return tuple(float, float, str): with the relation
            ...
            current mode
        """
        return self._mw_device.set_cw(freq=frequency, power=power)
